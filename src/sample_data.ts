...
export const sample_post: Post[] = [
    {
        ...
        content: 'Lập trình Angular là một kỹ năng lập trình web giúp bạn tạo các ứng dụng web hiện đại và tương tác. Angular là một framework JavaScript mã nguồn mở được phát triển bởi Google. Nó sử dụng TypeScript, một ngôn ngữ lập trình dựa trên JavaScript. Angular được thiết kế để tạo các ứng dụng web một trang (SPA) ...',
        author: 'Nguyễn Văn A',
